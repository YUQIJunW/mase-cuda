...
def main():
    ...
    if training_args.do_eval:
        ...
        peak_memory_fp32 = torch.cuda.max_memory_allocated()
        
        logger.info("*** Evaluate with Quantize***")
        for layer_name, layer in model.named_modules():
            ...
            if "classifier" in layer_name:
                continue
            layer.cuda()
            layer_q = QLinearPacked.build_from_linear(layer, group_size=data_args.group_size)
