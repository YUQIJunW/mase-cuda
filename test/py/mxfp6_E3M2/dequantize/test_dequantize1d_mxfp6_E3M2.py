...
from mase_cuda.mxfp6_E3M2.dequantize import dequantize1d_E3M2, dequantize1d_E3M2_simulated
from mase_cuda.mxfp6_E3M2.quantize import quantize1d_E3M2_simulated
...
def test_ext_dequantize1d():
    ...
    for group_size in group_sizes:
        for _ in range(num_random_tests):
            for m in num_elements:
                ...
                out_cpu = dequantize1d_E3M2(x, scales, group_size)
                out_ref = dequantize1d_E3M2_simulated(x, scales, group_size)
                ...
                out_gpu = dequantize1d_E3M2(x.cuda(), scales.cuda(), group_size).cpu()
    ...
    logger.info("test_ext_dequantize1d_E3M2: PASS")
