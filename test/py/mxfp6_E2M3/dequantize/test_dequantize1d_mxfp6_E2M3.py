...
from mase_cuda.mxfp6_E2M3.dequantize import dequantize1d_E2M3, dequantize1d_E2M3_simulated
from mase_cuda.mxfp6_E2M3.quantize import quantize1d_E2M3_simulated
...
def test_ext_dequantize1d():
    ...
    for group_size in group_sizes:
        for _ in range(num_random_tests):
            for m in num_elements:
                ...
                out_cpu = dequantize1d_E2M3(x, scales, group_size)
                out_ref = dequantize1d_E2M3_simulated(x, scales, group_size)
                ...
                out_gpu = dequantize1d_E2M3(x.cuda(), scales.cuda(), group_size).cpu()
    ...
    logger.info("test_ext_dequantize1d_E2M3: PASS")
